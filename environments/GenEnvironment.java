package progettoFinale.environments;
...
import progettoFinale.parser.ast.NamedEntity;
...
public class GenEnvironment<T> implements Environment<T> {
	...
	/*
	 * updates the innermost scope by associating 'var' with 'info'; 'var' is not
	 * allowed
	...
	/*
	 * updates the 'info' of the innermost variable 'var', throws an
	 * 'EnvironmentException' if no varibale 'var' can be
